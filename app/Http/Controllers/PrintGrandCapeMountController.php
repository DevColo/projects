...
class PrintGrandCapeMountController extends Controller
{
    //
    public function getPDF(){
    	...
    	$pdf=PDF::loadView('grandCapeMountCountyRooster',['member'=>$member]);

        //converting the view(page) called members to a pdf file in the browser
    	return $pdf->stream('grandCapeMountCountyRooster.pdf');
    }
}
