...
class GbarpoluDistController extends Controller
{
    //
    public function dist1(){
    	...
    	$pdf=PDF::loadView('gbarpoluDist1',['member'=>$member]);

        //converting the view(page) called members to a pdf file in the browser
    	return $pdf->stream('gbarpoluDist1.pdf');
    }
     ...
     public function dist2(){
    	...
    	//$member = Members::all();
         $member = DB::table('members')
            ...
            ->get();
    	//Displaying the view(page) called members
    	$pdf=PDF::loadView('gbarpoluDist2',['member'=>$member]);

        //converting the view(page) called members to a pdf file in the browser
    	return $pdf->stream('gbarpoluDist2.pdf');
    }
    ...
    public function dist3(){
    	...
    	//$member = Members::all();
         $member = DB::table('members')
            ...
            ->get();
    	//Displaying the view(page) called members
    	$pdf=PDF::loadView('gbarpoluDist3',['member'=>$member]);

        //converting the view(page) called members to a pdf file in the browser
    	return $pdf->stream('gbarpoluDist3.pdf');
}
}
