...
class PrintMontserradoController extends Controller
{
    //
    public function getPDF(){
    	...
    	$pdf=PDF::loadView('montserradoCountyRooster',['member'=>$member]);

        //converting the view(page) called members to a pdf file in the browser
    	return $pdf->stream('montserradoCountyRooster.pdf');
    }
}
