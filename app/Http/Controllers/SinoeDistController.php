...
class SinoeDistController extends Controller
{
    //
    public function dist1(){
    	...
    	$pdf=PDF::loadView('sinoeDist1',['member'=>$member]);

        //converting the view(page) called members to a pdf file in the browser
    	return $pdf->stream('sinoeDist1.pdf');
    }
     ...
     public function dist2(){
    	...
    	//$member = Members::all();
         $member = DB::table('members')
            ...
            ->get();
    	//Displaying the view(page) called members
    	$pdf=PDF::loadView('sinoeDist2',['member'=>$member]);

        //converting the view(page) called members to a pdf file in the browser
    	return $pdf->stream('sinoeDist2.pdf');
    }
    ...
    public function dist3(){
    	...
    	//$member = Members::all();
         $member = DB::table('members')
            ...
            ->get();
    	//Displaying the view(page) called members
    	$pdf=PDF::loadView('sinoeDist3',['member'=>$member]);

        //converting the view(page) called members to a pdf file in the browser
    	return $pdf->stream('sinoeDist3.pdf');
    }
}
