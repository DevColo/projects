...
class GeeDistController extends Controller
{
    //
    public function dist1(){
    	...
    	$pdf=PDF::loadView('geeDist1',['member'=>$member]);

        //converting the view(page) called members to a pdf file in the browser
    	return $pdf->stream('geeDist1.pdf');
    }
     ...
     public function dist2(){
    	...
    	//$member = Members::all();
         $member = DB::table('members')
            ...
            ->get();
    	//Displaying the view(page) called members
    	$pdf=PDF::loadView('geeDist2',['member'=>$member]);

        //converting the view(page) called members to a pdf file in the browser
    	return $pdf->stream('geeDist2.pdf');
    }
    ...
    public function dist3(){
    	...
    	//$member = Members::all();
         $member = DB::table('members')
            ...
            ->get();
    	//Displaying the view(page) called members
    	$pdf=PDF::loadView('geeDist3',['member'=>$member]);

        //converting the view(page) called members to a pdf file in the browser
    	return $pdf->stream('geeDist3.pdf');
    }
}
