...
<body>
	<div style="width:100%; height: 100px;background:#fff;margin-bottom: 20px;">
		...
		<img src="images/cdc.jpeg" width="85px" style="float:left;margin-top:-12px;position:relative;">
				<img src="images/River-Cess.jpg" width="110px" style="float:right;">
			...
			<div style="margin-top:-5px;">	<p style="text-align: center;text-decoration:underline;">River Cess County General Rooster</p></div>
